...
if (! file.exists("CD14mono.html") ) { mitch_report(mres2,outfile="CD14mono.html") }
...
if (! file.exists("NK2.html") ) { mitch_report(mres3,outfile="NK2.html") }
...
if (! file.exists("CD14monoCCL4.html") ) { mitch_report(mres4,outfile="CD14monoCCL4.html") }
...
if (! file.exists("FCGR3Amono.html") ) { mitch_report(mres5,outfile="FCGR3Amono.html") }
...
if (! file.exists("T.html") ) { mitch_report(mres6,outfile="T.html") }
...
if (! file.exists("DC.html") ) { mitch_report(mres7,outfile="DC.html") }
...
if (! file.exists("macrophage.html") ) { mitch_report(mres8,outfile="macrophage.html") }
...
if (! file.exists("B.html") ) { mitch_report(mres9,outfile="B.html") }
...
heatmap.2(as.matrix(jj),trace="none",scale="none",
  margin=c(8,20),col=colfunc(25),cexCol=0.8)
